...
public interface CSVParser {
	 ...
	 * @implNote if there is any error found in finding the file or parsing the file, {@code null}
	 * is returned and a message is printed to the error console. No errors are ever propagated
	 * from this Functional Interface.
	 */
