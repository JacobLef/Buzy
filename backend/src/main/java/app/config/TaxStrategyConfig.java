...
import app.strategy.tax.FlatTaxStrategy;
import app.strategy.tax.ProgressiveTaxStrategy;
...
/**
 * Configuration for Tax Calculation Strategy beans.
 * Provides default FlatTaxStrategy and optional ProgressiveTaxStrategy.
 */
@Configuration
public class TaxStrategyConfig {
    ...
    /**
     * Default flat tax strategy bean.
     * Used by PayrollServiceImpl as the primary tax calculation strategy.
     */
    ...
    /**
     * Progressive tax strategy bean (optional).
     * Can be used for tiered tax calculations.
     */
