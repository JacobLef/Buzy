...
/**
 * DTO for Payroll Summary/Report response Contains aggregated statistics for payroll analysis
 *
 * @author Qing Mi
 */
public record PayrollSummaryDTO(Long businessId, String businessName, LocalDate startDate,
    LocalDate endDate, Integer totalPaychecks, Integer totalEmployees, Double totalGrossPay,
    Double totalBonus, Double totalTaxDeductions, Double totalInsuranceDeductions,
    Double totalDeductions, Double totalNetPay, Double averageGrossPay, Double averageNetPay,
    Double averageTaxRate, Double averageInsuranceRate) {
