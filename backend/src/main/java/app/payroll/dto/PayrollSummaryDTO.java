...
public record PayrollSummaryDTO(
  ...
  public PayrollSummaryDTO {
    ...
    double totalCompensation =
        (totalGrossPay != null ? totalGrossPay : 0.0) + (totalBonus != null ? totalBonus : 0.0);
    if (totalCompensation > 0) {
      averageTaxRate = totalTaxDeductions != null ? totalTaxDeductions / totalCompensation : 0.0;
      averageInsuranceRate =
          totalInsuranceDeductions != null ? totalInsuranceDeductions / totalCompensation : 0.0;
    } else {
      averageTaxRate = 0.0;
