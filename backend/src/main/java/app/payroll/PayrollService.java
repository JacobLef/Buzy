...
/**
 * Service interface for payroll operations Handles payroll calculations, bonus
 * distribution, and tax strategy management
 *
 * @author Qing Mi
 */
public interface PayrollService {
	 ...
	 *            ID of the employee
	 * @param additionalPay
	 *            Additional amount to add to base salary
	 * @return PaycheckDTO with calculated gross, deductions, and net pay
	 * @throws ResourceNotFoundException
	 *             if employee not found
	 * @throws PayrollCalculationException
	...
	/**
	 * Preview payroll calculation without saving to database Used for displaying
	 * preview before user confirms
	 *
	 * @param employeeId
	 *            ID of the employee
	 * @param additionalPay
	 *            Optional additional pay (bonus, overtime, etc.)
	...
	/**
	 * Distribute bonuses to employees in a business All operations are performed in
	 * a single transaction
	 *
	 * @param request
	 *            Bonus distribution request with businessId, amount, and filters
	 * @return List of PaycheckDTOs for all processed employees
	 * @throws ResourceNotFoundException
	 *             if business not found
	 * @throws BusinessValidationException
	 *             if business has no employees
	 */
	 ...
	 *
	 * @param strategy
	 *            New tax calculation strategy to use
	...
	/**
	 * Update/correct an existing paycheck Only allowed if status is DRAFT
	 *
	 * @param paycheckId
	 ...
	 * @param taxDeduction
	 *            Updated tax deduction (optional)
	 * @param insuranceDeduction
	 *            Updated insurance deduction (optional)
	 * @return Updated PaycheckDTO
	 * @throws ResourceNotFoundException
	 *             if paycheck not found
	 * @throws PayrollCalculationException
	 *             if update fails or paycheck is not in DRAFT status
	 */
	PaycheckDTO updatePaycheck(Long paycheckId, Double grossPay, Double bonus, Double taxDeduction,
	 ...
	 *             if paycheck not found
	 * @throws PayrollCalculationException
	 *             if paycheck is not in DRAFT status
	 */
