 ...
 * {@link Employer}). Uses JOINED inheritance - each subclass has its own table
 * with a foreign key to this table.
 */
@Entity
...
public abstract class BusinessPerson {
	...
	public String toString() {
		return getPersonType() + "{" + "id=" + id + ", name='" + name + '\'' + ", email='" + email + '\'' + ", salary="
				+ salary + ", hireDate=" + hireDate + ", status='" + status + '\'' + '}';
	}
}
