...
/**
 * A factory for BusinessPerson objects, such that it permits the creation of
 * employees and employers, with the goal of abstracting away the construction
...
public class BusinessPersonFactory {
	...
	/**
	 * Create an Employee with respect to the provided parameters (excluding a
	 * manager).
	 */
	public static Employee createEmployee(String name, String email, String password, Double salary, String position) {
	 ...
	 * Create an Employer.
	 */
	public static Employer createEmployer(String name, String email, String password, Double salary, String department,
			String title) {
