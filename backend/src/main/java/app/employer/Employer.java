...
public class Employer extends BusinessPerson {
	...
	public Employer(String name, String email, String password, Double salary, String department, String title) {
	...
	public String toString() {
		return "Employer{" + "id=" + getId() + ", name='" + getName() + '\'' + ", email='" + getEmail() + '\''
				+ ", department='" + department + '\'' + ", title='" + title + '\'' + ", salary=" + getSalary()
				+ ", hireDate=" + getHireDate() + ", directReports=" + getDirectReportsCount() + ", status='"
				+ getStatus() + '\'' + '}';
	}
}
