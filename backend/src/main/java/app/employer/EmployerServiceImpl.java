...
public class EmployerServiceImpl implements EmployerService {
	...
	public EmployerServiceImpl(EmployerRepository employerRepository, BusinessRepository businessRepository,
	...
	public Employer createEmployer(CreateEmployerRequest request) {
		Employer employer = new Employer(request.name(), request.email(), request.password(), request.salary(),
	...
	public Employer updateEmployer(Long id, UpdateEmployerRequest request) {
		Employer employer = employerRepository.findById(id).orElseThrow(() -> new EmployerNotFoundException(id));
