 ...
 * User has a foreign key to BusinessPerson (Employee or Employer).
 */
@Entity
...
public class User {
    ...
    /**
     * Email for login - must match BusinessPerson.email.
     * This is the unique identifier for authentication.
     */
